...
function wpex_get_social() {
	...
	//define array of icons
	$social_icons = array('twitter','facebook','google','googleplus','pinterest','flickr','yahoo','dribbble','tumblr','vimeo','youtube','linkedin','forrst', 'apple', 'behance', 'blogger', 'friendfeed','deviantart','digg', 'forrst','lastfm', 'netvibes', 'picasa', 'newsvine', 'orkut','reddit','skype','rss','mail','support');
